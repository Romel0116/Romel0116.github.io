...
const announcementsTeamName =
    document.getElementById("announcementsTeamName");

const announcementsStatus =
    document.getElementById("announcementsStatus");

const announcementComposer =
    document.getElementById("announcementComposer");
...
const backToTeamFromAnnouncements =
    document.getElementById("backToTeamFromAnnouncements");

const announcementsLogoutBtn =
    document.getElementById("announcementsLogoutBtn");

const announcementsPageMessage =
    document.getElementById("announcementsPageMessage");
...
function showAnnouncementsMessage(
    text,
    type = "error"
) {
...
function disableAnnouncementsPage(message) {
    announcementsTeamName.textContent =
    ...
    announcementsList.innerHTML =
        `<p class="announcements-empty-message">${message}</p>`;
}
    ...
    unsubscribeFromAnnouncements =
        onSnapshot(
            ...
            (snapshot) => {
                ...
                if (snapshot.empty) {
                    announcementsList.innerHTML =
                        `<p class="announcements-empty-message">
...
async function loadTeam(user) {
    ...
    try {
        ...
        console.error(
            "Unable to load announcement page:",
            error
        );
...
postAnnouncementBtn.addEventListener(
    ...
    async () => {
        ...
        if (
            ...
            showAnnouncementsMessage(
                "The announcement page is not ready."
            );
        ...
        if (
            ...
            showAnnouncementsMessage(
                "Only the team owner can post announcements."
            );
...
announcementsLogoutBtn.addEventListener(
    "click",
    async () => {
        announcementsLogoutBtn.disabled = true;
        announcementsLogoutBtn.textContent =
            "Logging Out...";
